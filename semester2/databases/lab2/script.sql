...
*/
SELECT count(DISTINCT "Н_ЛЮДИ"."ИД") --todo мб придётся убрать DISTINCT
FROM "Н_ЛЮДИ"
...
*/
SELECT "ФАМИЛИЯ", "ЧИСЛО_ФАМИЛИЙ"
FROM (SELECT "Н_ЛЮДИ"."ФАМИЛИЯ", COUNT("Н_ЛЮДИ"."ФАМИЛИЯ") AS "ЧИСЛО_ФАМИЛИЙ"
      FROM "Н_ЛЮДИ"
               JOIN "Н_УЧЕНИКИ" ON "Н_УЧЕНИКИ"."ЧЛВК_ИД" = "Н_ЛЮДИ"."ИД"
               JOIN "Н_ПЛАНЫ" ON "Н_УЧЕНИКИ"."ИД" = "Н_ПЛАНЫ"."ПЛАН_ИД"
               JOIN "Н_ФОРМЫ_ОБУЧЕНИЯ" ON "Н_ПЛАНЫ"."ФО_ИД" = "Н_ФОРМЫ_ОБУЧЕНИЯ"."ИД"
